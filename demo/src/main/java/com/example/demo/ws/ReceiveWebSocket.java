...
public class ReceiveWebSocket extends BaseWebSocketEndPoint {
     ...
     */
    private static final ConcurrentHashMap<String, ReceiveWebSocket> webSocketMap = new ConcurrentHashMap<>();
    ...
    public void initSocket(ShipService shipService) {
        ReceiveWebSocket.shipService = shipService;
    }
    ...
    public void onClose() {
        //从map中删除
        ReceiveWebSocket socket = webSocketMap.get(userId);
    ...
    public void onMessage(String message, Session session) throws IOException {
        ...
        if ("ping".equals(message)) {
            ...
            shipService.receiveData(message);
        }
    }
